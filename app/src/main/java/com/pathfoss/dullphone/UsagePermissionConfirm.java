...
public class UsagePermissionConfirm extends DialogFragment {

    private final StartServiceListener startServiceListener;

    // Create constructor to pass the StartServiceListener interface
    public UsagePermissionConfirm (StartServiceListener startServiceListener) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // Inflate the view
        View view = inflater.inflate(R.layout.dialog_permission_usage_access, container, false);

        // Set button listeners
        view.findViewById(R.id.b_cancel).setOnClickListener(v -> dismiss());
        view.findViewById(R.id.b_confirm).setOnClickListener(v -> {
            dismiss();
            startServiceListener.usagePermissionRequested();
        });
